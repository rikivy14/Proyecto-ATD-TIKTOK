...
### 1. Requisitos
Necesitas instalar las librerías:
```bash
...
3. Ejecución
Ejecuta proyecto_principal.py para descargar datos y ver el gráfico.

Ejecuta server_socket.py en una terminal (Receptor).

Ejecuta client_socket.py en otra terminal (Emisor).
